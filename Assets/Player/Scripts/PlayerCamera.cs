...
public class PlayerCamera : MonoBehaviour
{
    ...
    [SerializeField] bool useTemporaryRT = false;

    [SerializeField] bool useOptimizations;



    [Header("References")]
    [SerializeField] RawImage renderOutput;
    ...
    void OnValidate()
    {
        ...
        if (!Application.isPlaying && useOptimizations) return;
    ...
    IEnumerator AutoRenderLoop()
    {
        ...
        {
            if (!Application.isFocused  && useOptimizations|| !gameObject.activeInHierarchy)
            {
                yield return null;
                continue;
            }
    ...
    public void ForceRenderOnce()
    {
        ...
        if (!Application.isFocused  && useOptimizations) return;
